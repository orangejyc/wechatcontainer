package org.orange.wechatcontainer.test.dao;
...
public class TentantDaoTests extends BaseDaoTestCase {
	...
	@Test
	public void test(){
		/*EntityDao tentantInfoDao = (EntityDao)this.getBean("tentantInfoDao");
		//assertNull(tentantInfoDao);
		TentantInfo tt=(TentantInfo)tentantInfoDao.getById("123");
		assertEquals(tt, null);  */
